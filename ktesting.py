...
model = load_model("K1_model.h5")

# Define gesture classes
actions = np.array(['Hello', 'Good', 'Morning', 'Help', 'House', 'Thankyou'])

# Generate colors dynamically for each action
colors = [(245, 117, 16), (117, 245, 16), (16, 117, 245), (245, 16, 245), (16, 245, 245), (245, 245, 16)]
